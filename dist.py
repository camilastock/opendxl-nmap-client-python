...
VERSION = __import__('dxlnmapclient').get_version()
RELEASE_NAME = "dxlnmapclient-python-dist-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlnmapclient")])
...
print("\nRemoving dxlnmapclient.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlnmapclient.egg-info"))
